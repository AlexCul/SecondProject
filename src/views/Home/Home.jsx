...
function Home() {
  ...
  const [isDiscountButtonActivated, setDiscountButtonActivated] =
    useState(true);
  const [notification, setNotification] = useState({
    isShown: false,
    title: "Congratulations!",
    message:
      "Your order with the discount has been successfully placed on the website.",
  });
    ...
    <>
      ...
      <section className={`${styles.head} notCentered`}>
        ...
        <Button
          ...
          dependencies={{}}
          style={{ width: "218px", marginTop: "40px" }}
        />
      </section>
      <section className={styles.categories}>
        <SectionBar
          title="Categories"
          button={{ text: "All categories", route: "/categories" }}
        />
            ...
            <input
              {...register("phoneNumber", {
                pattern: {
                  value: /\(\d{3}\) \d{3}-\d{4}/,
                  message:
                    "Please enter a phone number like this: (123) 456-7890",
                },
            ...
            <input
              {...register("email", {
                pattern: {
                  value: /\w@\w.\w/,
                  message:
                    "Please enter a valid email like this: example.email@gmail.com",
                },
      ...
      <section className={styles.sale}>
        <SectionBar
          title="Sale"
          button={{ text: "All sales", route: "/sales" }}
        />
