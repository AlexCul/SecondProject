    ...
    return (
        <div className={styles.orderForm}>
            ...
            <form onSubmit={handleSubmit((data) => onSubmit(data))}>
                <input {...register("username")} type="text" placeholder="Name" onChange={onChange} />
                <input {...register("phoneNumber")} type="text" placeholder="Phone number" onChange={onChange} />
                <input {...register("email")} type="text" placeholder="Email" onChange={onChange} />
